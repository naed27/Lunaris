import { Message, MessageEmbed, MessageReaction, ReactionCollector, TextChannel, User, Guild, GuildMember } from 'discord.js';
...
export default class Host{
    ...
    async sendGameInvite(channel:TextChannel,summoner:User){
        ...
        reactCollector.on('collect', async (reaction, user) => {
            ...
            if(reactionName=="❌") return this.closeInvite(user);
    ...
    closeInvite = ( user:User) => this.reactCollector.stop();
